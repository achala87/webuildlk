<!DOCTYPE html>
    ...
    <body class="antialiased">
        ...
        <h1><?php echo e(__('home_page_title')); ?></h1>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="<?php echo e(route('list-organizations', app()->getLocale())); ?>" class="underline text-gray-900 dark:text-white"><h2><?php echo e(__('rate_org_home_page_title')); ?><h2></a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <?php echo e(__('rate_org_home_page_description')); ?>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="<?php echo e(route('anti-corruption', app()->getLocale())); ?>" class="underline text-gray-900 dark:text-white"><h2><?php echo e(__('pledge_home_page_title')); ?></h2></a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <?php echo e(__('pledge_home_page_description')); ?>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="<?php echo e(route('value-added-economy', app()->getLocale())); ?>" class="underline text-gray-900 dark:text-white"><h2><?php echo e(__('value_added_home_page_title')); ?></h2></a></div>
                        </div>
                        
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <?php echo e(__('value_added_home_page_description')); ?>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="<?php echo e(route('centralized-cities-environment', app()->getLocale())); ?>" class="underline text-gray-900 dark:text-white"><h2><?php echo e(__('dev_plan_home_page_title')); ?></h2></a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <?php echo e(__('dev_plan_home_page_description')); ?>
