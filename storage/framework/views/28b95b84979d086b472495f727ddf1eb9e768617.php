<?php $__env->startSection('page_description', 'Buildlk is a volunteer effort by citizens of Sri Lanka and a few expatriates from a diverse range of proffesions to face the reality of government lead corruption and national failures by providing information and proactive solutions'); ?>
<?php $__env->startSection('page_keywords', 'Sri Lankan citizens, voluneering for nation building, uplift sri lanka, corruption free sri lanka, about the people behind buildlk'); ?>
<?php $__env->startSection('page_author', 'Volunteers of buildlk'); ?>
...
<div class="container mt-3"><i>BuildLk is a citizen initiative to sustainably develop a corruption free Sri Lanka</i></div> 
      ...
      <div class="card gallerycard"> 
            <img src="<?php echo e(url('/assets/profiles/achala.jpeg')); ?>" alt="achala-profile-picture"  width="100px;" height="120px" class="center">
      ...
      <div class="card gallerycard">
            <img src="<?php echo e(url('/assets/profiles/madhura.jpeg')); ?>" alt="madhura-profile-picture"  width="100px;" height="120px" class="center">
            <div class="container2">
      ...
      <div class="card gallerycard">
            <img src="<?php echo e(url('/assets/profiles/shiran.jpeg')); ?>" alt="shiran-profile-picture"  width="100px;" height="120px" class="center">
            <div class="container2">
      ...
      <div class="card gallerycard">
            <img src="<?php echo e(url('/assets/profiles/jayantha.jpeg')); ?>" alt="jayantha-profile-picture"  width="100px;" height="120px" class="center">
            <div class="container2">
      ...
      <div class="card gallerycard">
            <img src="<?php echo e(url('/assets/profiles/nalika.png')); ?>" alt="nalika-profile-picture" class="center" width="100px;" height="120px">
            <div class="container2">
...
<?php /**PATH /var/www/html/resources/views/about-us.blade.php ENDPATH**/ ?>