...
<head>
    ...
    <title>{{ __('#buildlk') }} - {{ $title ?? __('Home') }}</title>
            ...
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand">
                    <a href="@route(getRouteName().'.home')">
                        <span class="logo-text">{{ __('#buildlk') }}</span>
                    </a>
                </div>
                <!-- End Logo -->
...
<!-- End Left Sidebar -->
    ...
    <div class="page-wrapper">
        ...
        <footer class="footer text-center text-muted">
            A citizen driven deployment by Sri Lankan volunteers to sustainably develop a corruption free Sri Lanka.<br>
            Thank you Adminmart Template and <a href="https://github.com/rezaamini-ir/laravel-easypanel">EasyPanel</a>.
