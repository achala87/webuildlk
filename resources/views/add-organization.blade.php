   ...
   <x-slot name="header">
    ...
    <form id="add-todo" method="post" action="{{ url('post-organization') }}"> 
      ...
      <div class="form-group">
        <label for="formGroupExampleInput">Organization Title *</label>
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="district" placeholder="Sample contact 1: 0771234567, Sample contact 2: 0771234568, "></textarea>
